...
<nav class="navbar-top3" style="font-family:'neon';">
   <div class="container text-center">
                <ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link2" href="/rental-project/item/list">상품 게시판</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="/rental-project/freeboard/freeboardlist">자유 게시판</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="/rental-project/notice/list">공지사항</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link2" href="/rental-project/privateboard/privateqnalist">1:1문의</a>
                    </li>
                </ul>
            </div>
</nav>
